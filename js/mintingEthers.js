...
const updateMintInfo = async() => {
    ...
    if (minted == MAX_SUPPLY) {
        $("#sold-out").html(`SOLD OUT. <br><br>AVAILABLE ON <a href="https://opensea.io/collection/ascended-nft-official" target="_blank" class="w-inline-block" style="text-decoration:none;color:blue;">OPENSEA⬈</a> & <a href="https://looksrare.org/collections/0x496299d8497A02b01f5Bc355298b0a831f06c522" target="_blank" class="w-inline-block" style="text-decoration:none;color:green;">LOOKSRARE⬈</a>`);
        $("#mint-button").remove();
